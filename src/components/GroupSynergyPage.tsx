        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="space-y-1">
            ...
            <p className="text-nw-parchment-soft/80 text-sm">
              Toggle war scope: <span className="text-nw-gold-soft font-semibold">Full only 30 MIN ATK or DEF</span> vs{" "}
              <span className="text-nw-gold-soft font-semibold">Full + Partial WAR Less than 20 MIN </span>. Compare a baseline group against other wars.
            </p>
